...
[/var/log/dmesg]
file = /var/log/dmesg
log_group_name = ${ecs_cluster}-OS-dmesg
log_stream_name = {instance_id}
[/var/log/messages]
file = /var/log/messages
log_group_name = ${ecs_cluster}-OS-messages
log_stream_name = {instance_id}
datetime_format = %b %d %H:%M:%S
[/var/log/ecs/ecs-init.log]
file = /var/log/ecs/ecs-init.log
log_group_name = ${ecs_cluster}-OS-ecs-init.log
log_stream_name = {instance_id}
datetime_format = %Y-%m-%dT%H:%M:%SZ
[/var/log/ecs/ecs-agent.log]
file = /var/log/ecs/ecs-agent.log
log_group_name = ${ecs_cluster}-OS-ecs-agent.log
log_stream_name = {instance_id}
datetime_format = %Y-%m-%dT%H:%M:%SZ
EOT
...
/opt/aws/bin/cfn-signal -e $? --stack ${ecs_cluster} --resource ECSAutoScalingGroup --region ${region}